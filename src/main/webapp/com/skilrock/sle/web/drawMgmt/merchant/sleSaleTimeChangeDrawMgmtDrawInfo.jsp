			...
			<div class="col-md-12">
				<div class="box box-info box-style">
					<div class="box-header box-header-style">
						<i class="fa fa-gear"></i><h3 class="box-title">Draw To Change Sale Start Time</h3>
					</div>
					<div class="box-body" >
							...
							<div class="panel panel-default col-md-12 box-panel-style" id="drawTableDiv">
								...
								<s:form  theme="simple" cssClass="form-horizontal" method="post" action="updateDrawSaleTime"  name="drawDetailsForm" id="drawDetailsForm" onsubmit="return validateUpdateFreeze()" >
									...
									<table id="tableData" class="table table-bordered table-striped panel-table-border-style" style="text-align:center">
											...
											<div class="col-md-5" align="left">
													Change Sale Start Time (In Seconds)
											</div>
											...
											<div class="col-md-2 right-button-div-style" align="left" ><button type="submit" class="btn btn-primary" id="updFrz">Update Sale Start Time</button></div>
