						...
						<div class="box box-info box-style">
							...
							<div class="box-body">
								<div class="panel panel-default col-md-12 box-panel-style"
									id="gameDiv">
									<s:form cssClass="form-horizontal" method="post" action="verifyTicketSubmit" theme="simple" id="f0" onsubmit="return (validateTicketNumber()&&formSubmit(this.id,'resultDiv'));">
