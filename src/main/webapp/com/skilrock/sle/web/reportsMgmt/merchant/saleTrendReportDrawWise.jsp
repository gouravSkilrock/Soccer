...
<head>
	...
	<title>Sports Lottery | Sale Trend Report</title>
</head>
			...
			<div class="col-md-12">
				<div class="box box-info box-style">
					<div class="box-header box-header-style">
						<i class="fa fa-gear"></i><h3 class="box-title main-heading">Sale Trend Report</h3>
					</div>
					<div class="box-body" >
						...
						<div class="col-md-3"></div>
							<div class="panel panel-default col-md-12 box-panel-style">
									<s:form theme="simple" cssClass="form-horizontal" method="post" action="saleTrendReportSearch" id="gameReportForm" onsubmit="return (validateFetchReportRequestForm()&&formSubmit(this.id,'resultDiv'));">
