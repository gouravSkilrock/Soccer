...
<html lang="en">
  ...
  <base href="<%=basePath%>">
    ...
    <title>Sports Lottery | Update Role Table Success</title>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-12">
					<h1>Hello User...</h1>
					<h2 class="subtitle alert alert-success" style="color:black">Update Role Table Action Completed Successfully !!</h2>
				</div>
